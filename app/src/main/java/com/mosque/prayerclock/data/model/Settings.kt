...
enum class WeatherProvider { MOSQUE_CLOCK, OPEN_WEATHER }
...
enum class PrayerServiceType(val displayName: String) {
...
object PrayerZones {
    val zones = listOf(
        PrayerZone(1, "Zone 1", "Colombo District, Gampaha District, Kalutara District"),
        PrayerZone(2, "Zone 2", "Jaffna District, Nallur"),
        PrayerZone(3, "Zone 3", "Mullaitivu District (except Nallur), Kilinochchi District, Vavuniya District"),
        ...
        PrayerZone(7, "Zone 7", "Kandy District, Matale District, Nuwara Eliya District"),
        PrayerZone(8, "Zone 8", "Batticaloa District, Ampara District"),
        PrayerZone(9, "Zone 9", "Trincomalee District"),
        PrayerZone(10, "Zone 10", "Badulla District, Monaragala District, Padiyatalawa, Dehiaththakandiya"),
