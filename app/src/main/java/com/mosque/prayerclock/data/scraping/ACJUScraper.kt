...
class ACJUScraper
    ...
    constructor(
         ...
         */
        suspend fun getPrayerTimesPdfUrl(
            zone: Int,
            year: Int,
            month: Int,
        ): String? {
         ...
         */
        fun getZoneDescription(zone: Int): String? = ZONE_MAPPINGS[zone]

        /**
         * Get month name for display purposes
         */
        fun getMonthName(month: Int): String? = MONTH_MAPPINGS[month]

        /**
         * Get all available zones
         */
        fun getAvailableZones(): List<Int> = ZONE_MAPPINGS.keys.sorted()
    }
