...
object AppColorThemes {
     ...
     */
    val ElegantCharcoal = ColorTheme(
        id = "elegant_charcoal",
     ...
     */
    val BurgundyElegance = ColorTheme(
     ...
     */
    fun getAllThemes(): List<ColorTheme> = listOf(
        ClassicMosque,
        MidnightBlue,
        DesertSand,
        RoyalPurple,
    ...
    fun getThemeById(id: String): ColorTheme {
        return getAllThemes().find { it.id == id } ?: ClassicMosque
    }
}
